...
pub async fn build_openapi_json(
    ...
    for content_type in content_model.list_types().await? {
        ...
        schemas.insert(
            entry_schema_name.clone(),
            content_entry_schema(&fields_schema_name),
        );
...
fn add_content_type_paths(paths: &mut Map<String, Value>) {
    ...
    insert_operation(
        ...
        operation(
            ...
            true,
            None,
            Some(vec![path_parameter("api_id", "string")]),
            map! {
    ...
    insert_operation(
        ...
        operation(
            ...
            Some(vec![
                ...
                query_parameter("pageSize"),
                query_parameter("sort"),
                query_parameter("populate"),
...
fn add_dynamic_content_detail_paths(
    ...
    insert_operation(
        ...
        operation(
            ...
            Some(vec![path_parameter("id", "string")]),
            map! {
...
fn add_dynamic_content_revision_paths(
    ...
    insert_operation(
        ...
        operation(
            ...
            Some(vec![
                path_parameter("id", "string"),
                path_parameter("version", "integer"),
            ]),
            map! {
    ...
    insert_operation(
        ...
        operation(
            ...
            Some(vec![
                query_parameter("page"),
                query_parameter("pageSize"),
                query_parameter("mime_type"),
                query_parameter("filename"),
            ]),
            map! {
...
fn add_plugin_management_paths(paths: &mut Map<String, Value>) {
    ...
    insert_operation(
        ...
        operation(
            ...
            true,
            None,
            Some(vec![path_parameter("name", "string")]),
            map! {
...
fn add_settings_paths(paths: &mut Map<String, Value>) {
    ...
    insert_operation(
        ...
        operation(
            ...
            true,
            None,
            Some(vec![path_parameter("namespace", "string")]),
            map! {
    ...
    insert_operation(
        ...
        operation(
            ...
            None,
            Some(vec![
                path_parameter("namespace", "string"),
                path_parameter("key", "string"),
            ]),
            map! {
    ...
    for (plugin_name, route_docs) in grouped {
        ...
        for route in route_docs {
            let full_path = format!(
                "/api/v1/x/{plugin_name}{}",
                normalize_plugin_path(&route.path)
            );
...
fn add_generic_plugin_path(paths: &mut Map<String, Value>, plugin_name: &str) {
    insert_operation(
        ...
        operation(
            ...
            false,
            None,
            Some(vec![path_parameter("path", "string")]),
            map! {
                "200" => json_response(json!({}), "插件响应")
            },
        ),
...
fn add_content_type_schemas(schemas: &mut Map<String, Value>) {
    ...
    schemas.insert(
        "ContentTypeDefinition".to_owned(),
        json!({
            "type": "object",
...
fn insert_operation(paths: &mut Map<String, Value>, path: &str, method: &str, operation: Value) {
    ...
    let object = path_entry
        .as_object_mut()
        .expect("path entry must be object");
